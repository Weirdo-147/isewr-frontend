                      ...
                      {compressionFileInput && !compressedImageUrl && (
                        <div className="max-w-md mx-auto">
                          <button 
                            ...
                            className="w-full py-3 px-4 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg shadow-sm transition-colors duration-200 flex items-center justify-center"
                          >
                            {isCompressing ? (
                              <>
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-4">
                            <a 
                              ...
                              className="flex-1 py-3 px-4 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg shadow-sm transition-colors duration-200 text-center flex items-center justify-center"
                            >
